# This is a project for testing gRPC communication with the server using the ReactJS framework

It does not run in this current version, trying to find a solution that doesn't use Envoy Proxy or find a better way to build the proxy
